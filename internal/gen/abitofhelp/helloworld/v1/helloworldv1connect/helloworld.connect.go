...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/abitofhelp/bzlmod/internal/gen/abitofhelp/helloworld/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	GreeterServiceName = "abitofhelp.helloworld.v1.GreeterService"
)
...
const (
	...
	GreeterServiceSayHelloProcedure = "/abitofhelp.helloworld.v1.GreeterService/SayHello"
)

// These variables are the protoreflect.Descriptor objects for the RPCs defined in this package.
var (
	greeterServiceServiceDescriptor        = v1.File_abitofhelp_helloworld_v1_helloworld_proto.Services().ByName("GreeterService")
	greeterServiceSayHelloMethodDescriptor = greeterServiceServiceDescriptor.Methods().ByName("SayHello")
)

// GreeterServiceClient is a client for the abitofhelp.helloworld.v1.GreeterService service.
type GreeterServiceClient interface {
	// Sends a greeting
	SayHello(context.Context, *connect.Request[v1.SayHelloRequest]) (*connect.Response[v1.SayHelloResponse], error)
}

// NewGreeterServiceClient constructs a client for the abitofhelp.helloworld.v1.GreeterService
...
// SayHello calls abitofhelp.helloworld.v1.GreeterService.SayHello.
...
// GreeterServiceHandler is an implementation of the abitofhelp.helloworld.v1.GreeterService
// service.
...
func NewGreeterServiceHandler(svc GreeterServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/abitofhelp.helloworld.v1.GreeterService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedGreeterServiceHandler) SayHello(context.Context, *connect.Request[v1.SayHelloRequest]) (*connect.Response[v1.SayHelloResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("abitofhelp.helloworld.v1.GreeterService.SayHello is not implemented"))
}
